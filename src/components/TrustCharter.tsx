  ...
  return (
    <div id="ethics" className="bg-white rounded-[2.5rem] p-8 sm:p-12 border border-deep-indigo/5 shadow-sm max-w-6xl mx-auto mt-16 lg:mt-24 select-none">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-8 sm:gap-8">
        {/* Pillar 1: Ethical */}
        <div className="flex flex-col items-center text-center p-2 sm:p-4 rounded-3xl hover:bg-cloud-dancer/30 transition-all duration-300">
          ...
          <h5 className="font-serif font-bold text-deep-indigo text-sm sm:text-base mb-1.5 sm:mb-2">
            {t('trustItemEthicalTitle', locale)}
          </h5>
          <p className="text-[11px] sm:text-xs text-deep-indigo/70 font-light leading-relaxed">
