...
`
  ...
  {
    title: '6:00 AM vs 7:00 AM: When is the Best Time to See Dolphins?',
    slug: '6am-vs-8am',
    markdown: `
...
Drive ten minutes west of Lovina to the Banjar Hot Springs (Air Panas Banjar). Nestled deep in a jungle valley, these sulfuric pools have been used for centuries for their natural healing properties. Arrive early at 7:00 AM to have the hot, emerald-green waters entirely to yourself before the day-trippers arrive. Soak under the stone dragon spouts, feeling the warm, mineral-rich water soothe your muscles.
